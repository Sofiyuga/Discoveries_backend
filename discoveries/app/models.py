...
class Discovery(models.Model):
    ...
    year = models.IntegerField(default=1993, verbose_name="Год открытия")

    status = models.IntegerField(choices=STATUS_CHOICES, default=1, verbose_name="Статус")
    date_created = models.DateTimeField(default=timezone.now(), verbose_name="Дата создания")
    date_formation = models.DateTimeField(default=timezone.now(), verbose_name="Дата формирования")
    date_complete = models.DateTimeField(default=timezone.now(), verbose_name="Дата завершения")
