# Generated by Django 4.2.5 on 2023-12-31 10:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2023, 12, 31, 10, 15, 14, 635329, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ('date_formation', models.DateTimeField(default=datetime.datetime(2023, 12, 31, 10, 15, 14, 635329, tzinfo=datetime.timezone.utc), verbose_name='Дата формирования')),
                ('date_complete', models.DateTimeField(default=datetime.datetime(2023, 12, 31, 10, 15, 14, 635329, tzinfo=datetime.timezone.utc), verbose_name='Дата завершения')),
